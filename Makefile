...
COMMON_PACKAGES = act atuin bash bat btop bun gh ghostty git glow herdr lazygit neofetch nvim omp powerline ranger starship tabtab thefuck vim worktrunk yazi zsh
